...
public class PlayerMove : MonoBehaviour
{
	...
	public void Move(float move, bool crouch, bool jump)
	{
		...
		if (m_Grounded || m_AirControl)
		{
			...
			//Moving player right and player is facing left
			if (move > 0 && !m_FacingRight)
			{
				Flip();
			}
			//Moving player left and player is facing right
	...
	private void Flip()
	{
		//Leaving this code here in case we want to flip the player character (via scale function) when changing direction
		//We may want to rotate it manually
